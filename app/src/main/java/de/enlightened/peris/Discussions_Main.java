...
public class Discussions_Main extends FragmentActivity {
    ...
    private CategoriesFragment.CategorySelectedListener categorySelected = new CategoriesFragment.CategorySelectedListener() {
  ...
  final private ActiveList.OnProfileSelectedListener profileActiveSelected = new ActiveList.OnProfileSelectedListener() {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (manifestAnalytics != null && !manifestAnalytics.contentEquals("0")) {
      ah.trackCustomScreen(manifestAnalytics, "Peris Forum Reader v" + getString(R.string.app_version) + " for Android");
    }
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    if ((keyCode == KeyEvent.KEYCODE_BACK)) {
      ...
      Log.i("Peris", "Back pressed, backstack size = " + application.stackManager.getBackStackSize(backStackId));
